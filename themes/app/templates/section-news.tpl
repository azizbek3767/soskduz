	...
	<div class="container">
		...
		<div class="row">
			<div class="novelties clearfix">
				{fetch_articles perPage=9 assign=sectionArticles section=$section.sectionId assignPagination=pagination page=$page path=$section.path seFriendly=true type_content='news'}
