...
<head>
    ...
    {if isset($article.articleId)}
        <script type="application/ld+json">
        {
          ...
          "@type": "Organization",
          "headline": "{if isset($article.title)}{substr($article.title, 0, 109)}{/if}",
                "url": "{$article.url}",
                "description": "{$article.description nofilter}",
                "image":{
                    "@type": "ImageObject",
                    "height": "630",
                    "width": "1200",
                    "url": "{$article.images.medium.url}"
                },
                "author": {
                    "@type": "Person",
                ...
                "logo": {
                  "@type": "ImageObject",
                  "url": "{$THEME_URL}/img/logo.png",
                  "width": "",
                  "height": ""
                }
                },
              "datePublished": "{$article.publishedOn}",
               "dateModified": "{$article.modifiedOn}",
               "mainEntityOfPage": "{$description nofilter}"
         }
          ...
          "@type": "Organization",
             ...
             "url": "{$SITE_URL}",
                ...
                "image":{
                    ...
                    "height": "630",
                    "width": "1200",
                    "url": "{$SITE_URL}/uploads/og_image.jpg"
                },
    ...
    <link rel="alternate" hreflang="en" href="{$GLOBAL_URL}/en/"/>
    <link rel="alternate" hreflang="uz" href="{$GLOBAL_URL}/uz/"/>
                                    ...
                                    <ul class="hide-list">
                                        {foreach item=navLang from=$LANGUAGES}
                                            <li {if ($SITE_LANG eq $navLang.codename) || (!$SITE_LANG && $navLang.isDefault)} class="hide"{/if}>
                                                <a rel="alternate" hreflang="{$navLang.codename}" href="{$navLang.url}"><img src="{$THEME_URL}/img/{$navLang.codename}.jpg"
                                                                                                                             alt="{$navLang.codename}"> <span>{$navLang.name}</span></a>
                                            </li>
                                        {/foreach}
                                    </ul>
                                </div>
            ...
            <div class="container">
                <ul class="navigation">
                    {foreach item=navItem1 from=$TREE name=navItems1}{if $navItem1.top_menu eq 1}{if $navItem1.status eq 'visible'}
                        <li>
                            {*                            <a href="{if $navItem1.sectionId eq 6} javascript:;{else}{$navItem1.url}{/if}">{$navItem1.alias}</a>*}
                            ...
                            {if $navItem1.sectionId eq 9}
                                ...
                                {*        					</ul>*}
                            {else}
                                {if isset($navItem1.subsections) && !empty($navItem1.subsections) && array_search('visible', array_column($navItem1.subsections, 'status')) !== false}
                                    <ul class="sub-menu">
                                        <div class="sub-menu-body">
                                            <div class="rectangle"></div>
...
{*                                            {/if}*}
                    ...
                    <li>
                        <div class="search">
                            <form action="{$GLOBAL_URL}/{if $LANG['codename'] neq 'ru'}{$LANG['codename']}/{/if}search.php" method="post">
                                <div class="input-content">
                                    ...
                                    <div class="search_place">
                                        ...
                                        <input type="search" name="query" value="{if isset($query)}{$query}{/if}" placeholder="{$LANG.search}" id="search_input"
                                               current_lang="{$LANG.codename}"
                                               global_url="{$GLOBAL_URL}/search_ajax.php" section_id="{$section.sectionId}" page="{$page}">
                                    </div>
        ...
        <div class="mob_menu_button_wrapper hidden-md hidden-lg">
            <div class="container">
                <div class="flex-1">
                    ...
                    <div class="menu-btn">
                        <button type="button" class="navbar-toggle collapse_menu" data-toggle="collapse" {*data-target="#myNavbar"*}>
                    ...
                    <div class="menu-wrapper">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            {foreach item=navItem1 from=$TREE name=navItems1}{if $navItem1.top_menu eq 1}{if $navItem1.status eq 'visible'}
                                <li class="dropdown">
                                    <a href="{$navItem1.url}">{$navItem1.alias}</a>
                                    {*                                    <a class="dropdown-toggle" href="{if $navItem1.sectionId eq 6}javascript:;{else}{$navItem1.url}{/if}">{$navItem1.alias}</a>*}
                                    {if $navItem1.sectionId eq 9}
