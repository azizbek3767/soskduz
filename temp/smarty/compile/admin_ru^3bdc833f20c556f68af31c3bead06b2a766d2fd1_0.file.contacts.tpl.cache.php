...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_68622b7942b516_81572716',
...
function content_68622b7942b516_81572716 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->compiled->nocache_hash = '123427776468622b792f1c81_57263221';
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array('activeItem'=>"contacts",'title'=>"Наши адреса"), 0, false);
?>
<div class="page-content-wrap">

    <?php if (isset($_smarty_tpl->tpl_vars['messages']->value['saved'])) {?><span id="savedMessage" onclick="noty({ text: 'Адрес &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
&raquo; сохранен.', layout: 'topRight', type: 'success', timeout: 1500 });"></span><?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['not_saved'])) {?><span id="notSavedError" onclick="noty({ text: 'Адрес &laquo;<?php if (isset($_smarty_tpl->tpl_vars['article']->value['title'])) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);
	...
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['article_not_found'])) {?><span id="articleNotFoundError" onclick="noty({ text: 'Адрес не найден или доступ запрещен.', layout: 'topRight', type: 'error', timeout: 1500 });"></span><?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['fileNameExists'])) {?><span id="fileNameExistsError" onclick="noty({ text: 'Адрес с таким URL уже существует. Введите другой URL.', layout: 'topRight', type: 'error', timeout: 1500 });"></span><?php }?>
...
<?php if (isset($_smarty_tpl->tpl_vars['action']->value['edit'])) {?>
	<div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top">
            <div class="col-md-3 col-xs-3 nopadding_left"><h2>Наши адреса</h2></div>
...
}?>/contacts.php<?php if (isset($_smarty_tpl->tpl_vars['page']->value)) {?>?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);
}?>'" /> &nbsp;
            <a class="btn btn-primary" href="contacts.php<?php if (isset($_smarty_tpl->tpl_vars['page']->value)) {?>?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);
}?>">Отменить</a>
        </div>
    </form>
...
, 'contacts');">(Одобрить)</p>
                                ...
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="contacts.php?action[edit]=true&article[articleId]=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['articleId'], ENT_QUOTES, 'UTF-8', true);?>
...
', 'contacts');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						<?php
}
...
?>
                                        ...
                                        <li class="active"><a href="contacts.php?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['number']->value, ENT_QUOTES, 'UTF-8', true);
...
if (isset($_smarty_tpl->tpl_vars['status']->value)) {?>&status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'UTF-8', true);
                                        ...
                                        ...
                                        <?php } else { ?>
                                        <li><a href="contacts.php?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['number']->value, ENT_QUOTES, 'UTF-8', true);
if (isset($_smarty_tpl->tpl_vars['query']->value)) {?>&query=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['query']->value, ENT_QUOTES, 'UTF-8', true);
}
if (isset($_smarty_tpl->tpl_vars['section']->value)) {?>&section=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'UTF-8', true);
}
