...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6864412f6f0df1_82277202',
...
function content_6864412f6f0df1_82277202 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->compiled->nocache_hash = '20105269016864412f587207_80672831';
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, $_smarty_tpl->cache_lifetime, array('activeItem'=>"what_we_do",'title'=>"Что мы делаем"), 0, false);
?>
<div class="page-content-wrap">
  
    <?php if (isset($_smarty_tpl->tpl_vars['messages']->value['saved'])) {?><span id="savedMessage" onclick="noty({ text: 'Новость &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
&raquo; сохранена.', layout: 'topRight', type: 'success', timeout: 1500 });"></span><?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['not_saved'])) {?><span id="notSavedError" onclick="noty({ text: 'Новость &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
&raquo; НЕ сохранена.', layout: 'topRight', type: 'error', timeout: 1500 });"></span><?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['fileName'])) {?><span id="fileNameError" onclick="noty({ text: 'Введите имя файла.', layout: 'topRight', type: 'error', timeout: 1500 });"></span><?php }?>
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['fileNameExists'])) {?><span id="fileNameExistsError" onclick="noty({ text: 'Новость с таким именем файла уже существует. Введите другое имя.', layout: 'topRight', type: 'error', timeout: 1500 });"></span><?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['errors']->value['fileNameCharacters'])) {?><span id="fileNameCharactersError" onclick="noty({ text: 'Имя файла может состоять только из следующих символов: A-Z a-z 0-9 . , - _', layout: 'topRight', type: 'error', timeout: 1500 });"></span><?php }?>
	<?php echo '<script'; ?>
>
...
<?php if (isset($_smarty_tpl->tpl_vars['action']->value['edit'])) {?>
	...
	<div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top"> 
            <div class="col-md-3 col-xs-3 nopadding_left"><h2>Что мы делаем</h2></div>
...
>
        $(function () {
            ...
            function n() { return fileName = $("#title").val(), fileName = fileName.replace(/[\s]+/gi, "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['filename_word_separator'], ENT_QUOTES, 'UTF-8', true);?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['fileName'], ENT_QUOTES, 'UTF-8', true);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" autocomplete="off" type="text" name="article[alias]" value="<?php if (isset($_smarty_tpl->tpl_vars['article']->value['alias'])) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <div class="col-md-4 col-xs-12">
                                <div class="col-md-12 col-xs-12 nopadding"><label class=" push-up-10  push-down-10 control-label"> Добавьте картинки</label><span class="dz-success"> </span></div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="meta_title" type="text" name="article[meta_title]" value="<?php if (isset($_smarty_tpl->tpl_vars['article']->value['meta_title'])) {
...
}?>/news.php?page=<?php if (isset($_smarty_tpl->tpl_vars['page']->value)) {
...
if (isset($_smarty_tpl->tpl_vars['status']->value)) {?>&status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'UTF-8', true);
            ...
            <a class="btn btn-primary"  href="news.php?page=<?php if (isset($_smarty_tpl->tpl_vars['page']->value)) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);
}
if (isset($_smarty_tpl->tpl_vars['section']->value)) {?>&section=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'UTF-8', true);
}
            ...
            <div class="col-md-6 col-xs-6 nopadding_right">                                                
                <div class="pull-right"> 
					...
					<span>
                        ...
                        <a class="btn btn-danger" href="what_we_do.php" ><span class="fa fa-list-alt"></span> Показать все блоки</a>
                        <?php } else { ?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['query']->value, ENT_QUOTES, 'UTF-8', true);
							...
							<div class="col-md-4 col-xs-12 nopadding_left">
                                <?php if (isset($_smarty_tpl->tpl_vars['section']->value)) {?>
                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['sections']->value,'selected'=>$_smarty_tpl->tpl_vars['section']->value,'name'=>"section",'class'=>"form-control select"),$_smarty_tpl);?>
