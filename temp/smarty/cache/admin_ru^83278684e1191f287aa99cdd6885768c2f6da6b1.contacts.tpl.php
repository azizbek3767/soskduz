<?php
/* Smarty version 3.1.33, created on 2025-06-30 11:15:21
  from '/home/soskduz/public_html/admin/templates/contacts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_68622b79581620_64604722',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3bdc833f20c556f68af31c3bead06b2a766d2fd1' => 
    array (
      0 => '/home/soskduz/public_html/admin/templates/contacts.tpl',
      1 => 1580302824,
      2 => 'file',
    ),
...
function content_68622b79581620_64604722 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
      <title>Наши адреса - Life Style CMS</title>
                    ...
                    <li class="xn-icon-button pull-right hidden-xs">
                        <a href="#" style="width: 40px;" data-toggle="tooltip" data-placement="left" title data-original-title="Компрессия выключена">
                            ...
                            <ul class="xn-drop-left animated zoomIn">
                                                                                                            <li class="active">
                                            <a href="https://www.sos-kd.uz/admin/contacts.php">
                                                <span class="flag flag-ru"></span> Русский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/en/contacts.php">
                                                <span class="flag flag-en"></span> Английский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/uz/contacts.php">
...
<div class="page-content-wrap">
    ...
    function deleteArticleMessage(){ noty({ text: 'Адрес удален.', layout: 'topRight', type: 'success', timeout: 1500 }) }
    ...
    <div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top">                        
            <div class="col-md-6 col-xs-6 nopadding_left"><h2>Наши адреса</h2></div> 
            <div class="col-md-6 col-xs-6 nopadding_right">                                                
                <div class="pull-right"> 
                    <a class="btn btn-danger" href="contacts.php?action[edit]=true" data-toggle="tooltip" data-placement="left" data-original-title="Добавить"><i class="fa fa-plus"></i></a>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="140">Действие</th>
                                                ...
                                                <tbody>
                                                    <tr id="article-81">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kontakty/81.htm" target="_blank" class="artTitle">Ассоциация SOS Детские деревни Узбекистана</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span style="color:yellow;" class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Контакты">Контакты</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-81">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="contacts.php?action[edit]=true&article[articleId]=81&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(81, 'Ассоциация SOS Детские деревни Узбекистана', 'contacts');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-80">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kontakty/80.htm" target="_blank" class="artTitle">Филиал Ассоциации SOS Детские деревни Узбекистана в г. Ташкенте</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Контакты">Контакты</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-80">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="contacts.php?action[edit]=true&article[articleId]=80&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(80, 'Филиал Ассоциации SOS Детские деревни Узбекистана в г. Ташкенте', 'contacts');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-79">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kontakty/79.htm" target="_blank" class="artTitle">Филиал Ассоциации SOS Детские деревни Узбекистана в г. Самарканде</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Контакты">Контакты</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-79">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="contacts.php?action[edit]=true&article[articleId]=79&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(79, 'Филиал Ассоциации SOS Детские деревни Узбекистана в г. Самарканде', 'contacts');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-78">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kontakty/78.htm" target="_blank" class="artTitle">Филиал Ассоциации SOS Детские деревни Узбекистана в Хорезмской области</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Контакты">Контакты</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-78">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="contacts.php?action[edit]=true&article[articleId]=78&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(78, 'Филиал Ассоциации SOS Детские деревни Узбекистана в Хорезмской области', 'contacts');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                        </tbody>
                        <tfoot>
                            <tr>
                                <td class="small" colspan="4">Результаты с <b>1</b> по <b>4</b> из <b>4</b></td>
