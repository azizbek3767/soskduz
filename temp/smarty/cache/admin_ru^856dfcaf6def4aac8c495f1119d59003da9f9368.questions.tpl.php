<?php
/* Smarty version 3.1.33, created on 2025-06-30 11:14:24
  from '/home/soskduz/public_html/admin/templates/questions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_68622b40a5a0b5_14501169',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ebbf5d8907390ead12c3c76918a3913654a23d4b' => 
    array (
      0 => '/home/soskduz/public_html/admin/templates/questions.tpl',
      1 => 1585652470,
      2 => 'file',
    ),
...
function content_68622b40a5a0b5_14501169 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
      <title>Вопросы и ответы - Life Style CMS</title>
                    ...
                    <li class="xn-icon-button pull-right hidden-xs">
                        <a href="#" style="width: 40px;" data-toggle="tooltip" data-placement="left" title data-original-title="Компрессия выключена">
                            ...
                            <ul class="xn-drop-left animated zoomIn">
                                                                                                            <li class="active">
                                            <a href="https://www.sos-kd.uz/admin/questions.php">
                                                <span class="flag flag-ru"></span> Русский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/en/questions.php">
                                                <span class="flag flag-en"></span> Английский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/uz/questions.php">
...
<div class="page-content-wrap">
    ...
    function deleteArticleMessage(){ noty({ text: 'Вопрос удален.', layout: 'topRight', type: 'success', timeout: 1500 }) }
    ...
    <div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top">                        
            <div class="col-md-6 col-xs-6 nopadding_left"><h2>Вопросы и ответы</h2></div> 
            <div class="col-md-6 col-xs-6 nopadding_right">                                                
                <div class="pull-right"> 
                    <a class="btn btn-danger" href="questions.php?action[edit]=true" data-toggle="tooltip" data-placement="left" data-original-title="Добавить"><i class="fa fa-plus"></i></a>
      				<span>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="140">Действие</th>
                                                ...
                                                <tbody>
                                                    <tr id="article-369">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/chto-my-delaem/voprosy-i-otvety/chto-predstavlyaet-soboj-organizatsiya-sos-detskie-derevni.htm" target="_blank" class="artTitle">Что представляет собой организация SOS Детские деревни?</a></td>
                              
                                <td style="line-height: 58px;" nowrap="nowrap" title="">Вопросы и ответы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-369">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="questions.php?action[edit]=true&article[articleId]=369&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(369, 'Что представляет собой организация SOS Детские деревни?', 'questions');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-368">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/chto-my-delaem/voprosy-i-otvety/chto-takoe-assotsiatsiya-sos-detskie-derevni-uzbekistana.htm" target="_blank" class="artTitle">Что такое Ассоциация SOS Детские деревни Узбекистана?</a></td>
                              
                                <td style="line-height: 58px;" nowrap="nowrap" title="">Вопросы и ответы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-368">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="questions.php?action[edit]=true&article[articleId]=368&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(368, 'Что такое Ассоциация SOS Детские деревни Узбекистана?', 'questions');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-367">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/chto-my-delaem/voprosy-i-otvety/chem-sos-detskie-derevni-otlichayutsya-ot-detskogo-doma-mehribonlik.htm" target="_blank" class="artTitle">Чем SOS Детские деревни отличаются от детского дома (Мехрибонлик)?</a></td>
                              
                                <td style="line-height: 58px;" nowrap="nowrap" title="">Вопросы и ответы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-367">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="questions.php?action[edit]=true&article[articleId]=367&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(367, 'Чем SOS Детские деревни отличаются от детского дома (Мехрибонлик)?', 'questions');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-366">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/chto-my-delaem/voprosy-i-otvety/kak-ustroeny-semi-integrirovannye-v-soobschestva-v-sos-detskoj-derevni-horezm.htm" target="_blank" class="artTitle">Как устроены семьи, интегрированные в сообщества в SOS Детской деревни...</a></td>
                              
                                <td style="line-height: 58px;" nowrap="nowrap" title="">Вопросы и ответы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-366">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="questions.php?action[edit]=true&article[articleId]=366&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(366, 'Как устроены семьи, интегрированные в сообщества в SOS Детской деревни Хорезм?', 'questions');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-365">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/chto-my-delaem/voprosy-i-otvety/kak-deti-popadayut-v-sos-detskuyu-derevnyu.htm" target="_blank" class="artTitle">Как дети попадают в SOS Детскую деревню?</a></td>
                              
                                <td style="line-height: 58px;" nowrap="nowrap" title="">Вопросы и ответы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-365">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="questions.php?action[edit]=true&article[articleId]=365&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(365, 'Как дети попадают в SOS Детскую деревню?', 'questions');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-364">
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/chto-my-delaem/voprosy-i-otvety/kak-zhivut-deti-v-sos-detskoj-derevne.htm" target="_blank" class="artTitle">Как живут дети в SOS Детской деревне?</a></td>
                              
                                <td style="line-height: 58px;" nowrap="nowrap" title="">Вопросы и ответы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-364">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="questions.php?action[edit]=true&article[articleId]=364&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteContent(364, 'Как живут дети в SOS Детской деревне?', 'questions');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                        </tbody>
                        <tfoot>
