...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_686017b0b80564_02137413',
...
function content_686017b0b80564_02137413 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
      <title>Социальные сети - Life Style CMS</title>
                    ...
                    <li class="xn-icon-button pull-right hidden-xs">
                        <a href="#" style="width: 40px;" data-toggle="tooltip" data-placement="left" title data-original-title="Компрессия выключена">
                            ...
                            <ul class="xn-drop-left animated zoomIn">
                                                                                                            <li class="active">
                                            <a href="https://www.sos-kd.uz/admin/socials.php">
                                                <span class="flag flag-ru"></span> Русский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/en/socials.php">
                                                <span class="flag flag-en"></span> Английский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/uz/socials.php">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Действие</th>
                                                    ...
                                                    <tbody>
                                                                    <tr id="social-2">
                                        <td class="" width="100%">Телеграм</td>
                                        <td class="" align="left">https://t.me/</td>
                                        <td style="" class="" align="center">Спрятан</td>
                                        <td class="btn-link-action text-center">
                                            <a class="btn btn-rounded" href="socials.php?action[edit]=true&social[socialId]=2"><span class="fa fa-pen"></span></a>
                                            <a class="btn btn-danger btn-rounded" onclick="deleteSocial(2, 'Телеграм');"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                                                    <tr id="social-1">
                                        <td class="" width="100%">Facebook</td>
                                        <td class="" align="left">https://www.facebook.com/SOSUzbekistan</td>
                                        <td style="" class="" align="center">Виден</td>
                                        <td class="btn-link-action text-center">
                                            <a class="btn btn-rounded" href="socials.php?action[edit]=true&social[socialId]=1"><span class="fa fa-pen"></span></a>
                                            <a class="btn btn-danger btn-rounded" onclick="deleteSocial(1, 'Facebook');"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                                                    <tr id="social-71">
                                        <td class="" width="100%">youtube</td>
                                        <td class="" align="left">https://www.youtube.com/</td>
                                        <td style="" class="" align="center">Спрятан</td>
                                        <td class="btn-link-action text-center">
                                            <a class="btn btn-rounded" href="socials.php?action[edit]=true&social[socialId]=71"><span class="fa fa-pen"></span></a>
                                            <a class="btn btn-danger btn-rounded" onclick="deleteSocial(71, 'youtube');"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                                                    <tr id="social-3">
                                        <td class="" width="100%">Instagram</td>
                                        <td class="" align="left">https://www.instagram.com/sos_cv_uzbekistan/</td>
                                        <td style="" class="" align="center">Виден</td>
                                        <td class="btn-link-action text-center">
                                            <a class="btn btn-rounded" href="socials.php?action[edit]=true&social[socialId]=3"><span class="fa fa-pen"></span></a>
                                            <a class="btn btn-danger btn-rounded" onclick="deleteSocial(3, 'Instagram');"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                                                    <tr id="social-72">
                                        <td class="" width="100%">LinkedIn</td>
                                        <td class="" align="left">https://www.linkedin.com/company/sos-children&#039;s-villages-uzbekistan/</td>
                                        <td style="" class="" align="center">Виден</td>
                                        <td class="btn-link-action text-center">
                                            <a class="btn btn-rounded" href="socials.php?action[edit]=true&social[socialId]=72"><span class="fa fa-pen"></span></a>
                                            <a class="btn btn-danger btn-rounded" onclick="deleteSocial(72, 'LinkedIn');"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                                            </tbody>
                            <tfoot>
