...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6864f073b3e6e9_12804600',
...
function content_6864f073b3e6e9_12804600 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
      <title>Контент - Life Style CMS</title>
                    ...
                    <li class="xn-icon-button pull-right hidden-xs">
                        <a href="#" style="width: 40px;" data-toggle="tooltip" data-placement="left" title data-original-title="Компрессия выключена">
                            ...
                            <ul class="xn-drop-left animated zoomIn">
                                                                                                            <li class="active">
                                            <a href="https://www.sos-kd.uz/admin/articles.php">
                                                <span class="flag flag-ru"></span> Русский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/en/articles.php">
                                                <span class="flag flag-en"></span> Английский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/uz/articles.php">
...
<option value="2">SOS Детские деревни Узбекистана</option>
<option value="58">SOS Детские деревни Узбекистана :: СМИ о нас</option>
<option value="13">SOS Детские деревни Узбекистана :: Официальные документы</option>
<option value="12">SOS Детские деревни Узбекистана :: Организационная структура</option>
<option value="11">SOS Детские деревни Узбекистана :: Ассоциация SOS Детские деревни в Узбекистане</option>
<option value="10">SOS Детские деревни Узбекистана :: Идея</option>
<option value="3">Что мы делаем</option>
<option value="18">Что мы делаем :: Проекты</option>
<option value="55">Что мы делаем :: Защита детей и молодежи</option>
<option value="17">Что мы делаем :: Сопровождение молодёжи</option>
<option value="16">Что мы делаем :: Поддержка уязвимых семей</option>
<option value="15">Что мы делаем :: Альтернативная опека</option>
<option value="4">Где мы работаем</option>
<option value="53">Где мы работаем :: Сурхандарьинская</option>
<option value="52">Где мы работаем :: Наманганская</option>
<option value="51">Где мы работаем :: Джизакская</option>
<option value="50">Где мы работаем :: Ферганская</option>
<option value="49">Где мы работаем :: Сырдарьинская</option>
<option value="47">Где мы работаем :: Навоийская</option>
<option value="46">Где мы работаем :: Кашкадарьинская</option>
<option value="45">Где мы работаем :: Бухарская</option>
<option value="44">Где мы работаем :: Республика Каракалпакстан</option>
<option value="43">Где мы работаем :: Андижанская</option>
<option value="21">Где мы работаем :: Ургенч и Шават (Хорезмская область)</option>
<option value="20">Где мы работаем :: Самарканд</option>
<option value="19">Где мы работаем :: Ташкент1</option>
<option value="48">Где мы работаем :: Ташкент</option>
<option value="6">Что можете сделать вы</option>
<option value="31">Что можете сделать вы :: Реквизиты для юридических лиц</option>
<option value="24">Что можете сделать вы :: Ящики для пожертвований</option>
<option value="23">Что можете сделать вы :: Благотворительные открытки</option>
<option value="22">Что можете сделать вы :: Помочь сейчас</option>
<option value="8">Ознакомительный фильм об Ассоциации SOS Детские деревни Узбекистана</option>
<option value="25">Что вы получите, работая в SOS Детские деревни Узбекистана:</option>
<option value="28">Что вы получите, работая в SOS Детские деревни Узбекистана: :: Кандидат на вакансию SOS воспитатель (SOS мама):</option>
<option value="27">Что вы получите, работая в SOS Детские деревни Узбекистана: :: Кандидат на вакансию в SOS Детской деревне:</option>
<option value="26">Что вы получите, работая в SOS Детские деревни Узбекистана: :: Кандидат на вакансию в Национальном офисе:</option>
<option value="37">Корзина</option>
<option value="38">Цифры и факты</option>
<option value="41">Цифры и факты :: Молодых людей из SOS</option>
<option value="40">Цифры и факты :: На сегодняшний день</option>
<option value="39">Цифры и факты :: SOS-семьях воспитывается</option>
<option value="54">Публичная оферта</option>
<option value="14">Вакансии</option>
<option value="30">Вакансии :: Принципы работы с персоналом:</option>
<option value="29">Вакансии :: Стандарты управления персоналом SOS Детские деревни Узбекистана:</option>
<option value="56">Политика конфиденциальности</option>
</select>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="140">Действие</th>
                                                ...
                                                <tbody>
                                                    <tr id="article-404">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">26.05.2025</td>
                                <td class="text-center">
                                                                        <img src="assets/img/no_images.jpg" class="article_img" style="width:45px;"/>
                                                                    </td>
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/vakansii/prizyv-k-nominatsiyam-v-chlenstvo-assotsiatsii.htm" target="_blank" class="artTitle">Призыв к номинациям в членство Ассоциации</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Вакансии">Вакансии</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-404">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=404&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(404, 'Призыв к номинациям в членство Ассоциации');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-403">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">26.05.2025</td>
                                ...
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/vakansii/menedzher-po-fandrajzingu.htm" target="_blank" class="artTitle">Менеджер по фандрайзингу</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Вакансии">Вакансии</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-403">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=403&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(403, 'Менеджер по фандрайзингу');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-402">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">26.05.2025</td>
                                ...
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/vakansii/spetsialist-po-individualnomu-fandrajzingu.htm" target="_blank" class="artTitle">Специалист по индивидуальному фандрайзингу</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Вакансии">Вакансии</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-402">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=402&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(402, 'Специалист по индивидуальному фандрайзингу');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-401">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">26.05.2025</td>
                                ...
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/vakansii/spetsialist-po-tsifrovomu-fandrajzingu.htm" target="_blank" class="artTitle">Специалист по цифровому фандрайзингу</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="Вакансии">Вакансии</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-401">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=401&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(401, 'Специалист по цифровому фандрайзингу');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-398">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">14.04.2025</td>
                                <td class="text-center">
                                                                        <img src="assets/img/no_images.jpg" class="article_img" style="width:45px;"/>
                                                                    </td>
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kto-my/otchety-i-ofitsialnye-dokumenty/politika-po-zaschite-detej-i-molodezhi-ot-zhestokogo-obrascheniya-2023.htm" target="_blank" class="artTitle">Политика по защите детей и молодежи от жестокого обращения 2023</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="SOS Детские деревни Узбекистана :: Официальные документы">Официальные документы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-398">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=398&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(398, 'Политика по защите детей и молодежи от жестокого обращения 2023');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-392">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">10.05.2024</td>
                                <td class="text-center">
                                                                        <img src="assets/img/no_images.jpg" class="article_img" style="width:45px;"/>
                                                                    </td>
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kto-my/otchety-i-ofitsialnye-dokumenty/auditorskij-otchet-po-mezhdunarodnym-standartam-za-2023-god.htm" target="_blank" class="artTitle">Аудиторский отчет по международным стандартам за 2023 год</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="SOS Детские деревни Узбекистана :: Официальные документы">Официальные документы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-392">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=392&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(392, 'Аудиторский отчет по международным стандартам за 2023 год');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-391">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">10.05.2024</td>
                                ...
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kto-my/otchety-i-ofitsialnye-dokumenty/auditorskij-otchet-po-natsionalnym-standartam-za-2023-god.htm" target="_blank" class="artTitle">Аудиторский отчет по национальным стандартам за 2023 год</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="SOS Детские деревни Узбекистана :: Официальные документы">Официальные документы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-391">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=391&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(391, 'Аудиторский отчет по национальным стандартам за 2023 год');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-390">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">29.12.2023</td>
                                <td class="text-center">
                                                                        <img src="assets/img/no_images.jpg" class="article_img" style="width:45px;"/>
                                                                    </td>
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kto-my/otchety-i-ofitsialnye-dokumenty/auditorskij-otchet-po-natsionalnym-standartam-za-2022-god.htm" target="_blank" class="artTitle">Аудиторский отчет по национальным стандартам за 2022 год</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="SOS Детские деревни Узбекистана :: Официальные документы">Официальные документы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-390">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=390&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(390, 'Аудиторский отчет по национальным стандартам за 2022 год');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-389">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">29.12.2023</td>
                                ...
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kto-my/otchety-i-ofitsialnye-dokumenty/auditorskij-otchet-po-mezhdunarodnym-standartam-za-2022-god.htm" target="_blank" class="artTitle">Аудиторский отчет по международным стандартам за 2022 год</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="SOS Детские деревни Узбекистана :: Официальные документы">Официальные документы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-389">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=389&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(389, 'Аудиторский отчет по международным стандартам за 2022 год');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                            <tr id="article-350">
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">24.10.2022</td>
                                <td class="text-center">
                                                                        <img src="assets/img/no_images.jpg" class="article_img" style="width:45px;"/>
                                                                    </td>
                                <td style="line-height: 58px;" width="100%"><a href="https://www.sos-kd.uz/kto-my/otchety-i-ofitsialnye-dokumenty/auditorskij-otchet-po-mezhdunarodnym-standartam-za-2021-god.htm" target="_blank" class="artTitle">Аудиторский отчет по международным стандартам за 2021 год</a></td>
                                <td style="line-height: 58px;" class="text-center" nowrap="nowrap">
                                    <span class="fa fa-star"></span>                                </td>
                                <td style="line-height: 58px;" nowrap="nowrap" title="SOS Детские деревни Узбекистана :: Официальные документы">Официальные документы</td>
                                <td style="line-height: 58px;min-width: 120px;" id="status-350">
                                    Включено
                                                                    </td>
                                <td class="btn-link-action text-center">
                                    <a class="btn btn-rounded" href="articles.php?action[edit]=true&article[articleId]=350&page=1"><span class="fa fa-pen"></span></a>  
                                    <a class="btn btn-danger btn-rounded" onclick="deleteArticle(350, 'Аудиторский отчет по международным стандартам за 2021 год');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
  						                        </tbody>
                        <tfoot>
                            <tr>
                                <td class="small" colspan="4">Результаты с <b>1</b> по <b>10</b> из <b>92</b></td>
                                <td align="right" colspan="3">
                                                 
                                    <ul class="pagination pagination-sm pull-right push-down-10 push-up-10">
                                                                                                                        <li class="active"><a href="articles.php?page=1">1</a></li>
                                                                                                                                                                <li><a href="articles.php?page=2">2</a></li>
                                                                                                                                                                <li><a href="articles.php?page=3">3</a></li>
                                                                                                                                                                <li><a href="articles.php?page=4">4</a></li>
                                                                                                                                                                <li><a href="articles.php?page=5">5</a></li>
                                                                                                                    </ul>  
                                                                    </td>
                            </tr>
                        </tfoot>
