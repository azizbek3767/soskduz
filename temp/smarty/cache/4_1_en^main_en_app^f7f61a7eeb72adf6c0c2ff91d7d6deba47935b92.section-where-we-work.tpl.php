...
function content_6878e212ddad55_17329022 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ru">
<!--[if IE 9]>
...
<head>
    ...
    <title>
                                    Where we work - For the rights and interests of children                        </title>

    <meta name="yandex-verification" content="3597182b950b0996"/>
    <meta charset="utf-8">
            <meta name="description" content="Where we work">            <meta name="keywords" content="Where we work">
    ...
    <meta name="robots" content="index,follow">
        ...
        <meta property="og:description" content="Where we work">
        ...
        <meta name="twitter:description" content="Where we work"/>
	...
	<div class="container">
        <ol class="breadcrumb font-w-6">
        	<li><a href="https://www.sos-kd.uz/en">Home</a></li>
        	        		        			        				<li class="active"><a href="https://www.sos-kd.uz/en/where-we-work/">Where we work</a></li>
        			        		        	        </ol>
    </div>
</div>
			...
			<div class="container p-v-md">
				<div class="traderoutes-content">
					<div class="traderoutes-items" data-container-country>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/surhandarya/">
																			<h5>Region</h5>									
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/namangan/">
																			<h5>Region</h5>									
									<h4>Наманганская</h4>
									<div class="text-item"></div>
								</a>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/djizak/">
																			<h5>Region</h5>									
									<h4>Джизакская</h4>
									<div class="text-item"></div>
								</a>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/fergana/">
																			<h5>Region</h5>									
									<h4>Ферганская</h4>
									<div class="text-item"></div>
								</a>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/sirdarya/">
																			<h5>Region</h5>									
									<h4>Сырдарьинская</h4>
									<div class="text-item"></div>
								</a>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/navoi/">
																			<h5>Region</h5>									
									<h4>Навоийская</h4>
									<div class="text-item"></div>
								</a>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/kashkadarya/">
																			<h5>Region</h5>									
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/bukhara/">
																			<h5>Region</h5>									
									<h4>Бухарская</h4>
									<div class="text-item"></div>
								</a>
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/karakalpakstan/">
								...
								<a href="https://www.sos-kd.uz/en/where-we-work/andizhan/">
																			<h5>Region</h5>									
									<h4>Андижанская</h4>
									<div class="text-item"></div>
								</a>
							</div>
													<div class="item khorezm " data-country="11">
								<a href="https://www.sos-kd.uz/en/where-we-work/khorezm/">
																			<h5>City</h5>
									
									<h4>Urgench and Shavat (Khorezm region)</h4>
									<div class="text-item"><h2>"SOS CHILDREN'S VILLAGES OF UZBEKISTAN" KHOREZM REGION BRANCH<br /><br /></h2>
...
<p><strong>E-mail</strong>:&nbsp;<a href="mailto:soscvurg@sos-kd.uz">soscvurg@sos-kd.uz</a></p></div>
								</a>
							</div>
													<div class="item samarkand " data-country="12">
								<a href="https://www.sos-kd.uz/en/where-we-work/samarkand/">
																			<h5>City</h5>
									
									<h4>Samarkand</h4>
									<div class="text-item"><h2>"SOS CHILDREN'S VILLAGES OF UZBEKISTAN" SAMARKAND BRANCH<br /><br /></h2>
...
<p><strong>E-mail</strong>:&nbsp;<a href="mailto:soscvsam@sos-kd.uz">soscvsam@sos-kd.uz</a></p></div>
								</a>
							</div>
													<div class="item tashkent " data-country="13">
								<a href="https://www.sos-kd.uz/en/where-we-work/tashkent/">
																			<h5>City</h5>
									
									<h4>Tashkent</h4>
									<div class="text-item"><h2>"SOS CHILDREN'S VILLAGES OF UZBEKISTAN" TASHKENT BRANCH<br /><br /></h2>
...
<p><strong>E-mail</strong>:&nbsp;<a href="mailto:soscvtash@sos-kd.uz">soscvtash@sos-kd.uz</a></p></div>
								</a>
							</div>
													<div class="item tashobl hiddem-xs hidden-sm" data-country="14">
								<a href="https://www.sos-kd.uz/en/where-we-work/tashobl/">
																			<h5>Region</h5>									
									<h4>Ташкентская</h4>
									<div class="text-item"><h2>"SOS CHILDREN'S VILLAGES OF UZBEKISTAN" TASHKENT BRANCH<br /><br /></h2>
<p><strong>Address</strong>: 100187, Tashkent , Temur Malik Str., 2B</p>
...
<p><strong>E-mail</strong>:&nbsp;<a href="mailto:soscvtash@sos-kd.uz">soscvtash@sos-kd.uz</a></p></div>
					...
					<div class="traderoutes-map">
													<img src="https://www.sos-kd.uz/themes/app/img/spec-marker.png" class="spec-marker-khorezm">
															<h4 class="spec-marker-khorezm" style="left: 13% !important; top: 47% !important;font-weight: bold;">Urgench and Shavat (Khorezm region)</h4>
																				<img src="https://www.sos-kd.uz/themes/app/img/spec-marker.png" class="spec-marker-samarkand">
															<h4 class="spec-marker-samarkand" style="font-weight: bold;top: 63%;left:50%;">Samarkand</h4>
																				<img src="https://www.sos-kd.uz/themes/app/img/spec-marker.png" class="spec-marker-tashkent">
															<h4 class="spec-marker-tashkent" style="font-weight: bold;top: 47%;right:27%;">Tashkent</h4>
						...
						<div class="desc-content"><p>Currently, the Association &ldquo;SOS Children's Villages of Uzbekistan&rdquo; implements programs in three regions of the country: Tashkent, Samarkand and Khorezm region.</p>
<p>The construction and full equipping of children's villages in Tashkent, the city of Samarkand and the Khorezm region, which provide more than 300 children without guardianship, provide various services (training, sports, leisure, psychological, pedagogical and legal support, etc.).</p>
<p>In particular, 83 children live in the family houses of the SOS Children's Villages of Uzbekistan branches in Tashkent, 88 in Samarkand, and 36 children in Urgench. In the city of Urgench, an integrated form of family custody was introduced, only 6 apartments and houses in various mahallas were acquired, 2 social centers were organized in the city of Urgench and the Shavatsky district.</p>
<p>In addition, the Association "SOS Children's Villages of Uzbekistan" and its branches in the cities. Tashkent, Samarkand and the Khorezm region on the basis of self-government bodies of citizens, youth homes, schools created services to strengthen the family and prevent social abandonment, loyal groups of teachers, parents and children (equipped with multimedia materials for lessons, new computer classes), social enterprises, of which the parents of children at risk of deprivation of parental care are employed, a number of gyms have been repaired and equipped with sports equipment.</p>
<p>For graduates of SOS Children's Villages in Uzbekistan, 2 youth houses were organized in Tashkent, in which 29 young people live and 2 youth houses in Samarkand, in which 31 young people live.</p>
<p>To date, the Association has 173 employees. Of these, 61 are employees in the branch of Tashkent, 60 in Samarkand and 37 in Urgench. Among them are such specialists as SOS mothers and assistants, social workers and teachers, lawyers and employment specialists.</p>
<p>The following is branch information.</p></div>
		</div>
	</div>
</div>
</main>
