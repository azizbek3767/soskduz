...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_687243dc652f74_33916006',
...
function content_687243dc652f74_33916006 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
      <title>Обзор - Статистика - Life Style CMS</title>
                    ...
                    <li class="xn-icon-button pull-right hidden-xs">
                        <a href="#" style="width: 40px;" data-toggle="tooltip" data-placement="left" title data-original-title="Компрессия выключена">
                            ...
                            <ul class="xn-drop-left animated zoomIn">
                                                                                                            <li class="active">
                                            <a href="https://www.sos-kd.uz/admin/stats.overview.php">
                                                <span class="flag flag-ru"></span> Русский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/en/stats.overview.php">
                                                <span class="flag flag-en"></span> Английский
                                            </a>
                                        </li>
                                                                                                                                                <li>
                                            <a href="https://www.sos-kd.uz/admin/uz/stats.overview.php">
...
<option value="last7days" selected="selected">последние 7 дней</option>
<option value="last14days">последние 14 дней</option>
...
<div class="row">
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body padding-0" id="total"><div class="chart-holder" id="visitors" style="height: 300px;"></div></div>
        </div>
        <script>
            Morris.Line({
                element: 'visitors',
