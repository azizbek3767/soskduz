 ...
 * This file contains the basic api and methods for compiling Smarty templates with lexer/parser
 *
 * @package    Smarty
 * @subpackage Compiler
 * @author     Uwe Tews
...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    private function compileTag2($tag, $args, $parameter)
    {
        ...
        // compile the smarty tag (required compile api to compile the tag are auto loaded)
