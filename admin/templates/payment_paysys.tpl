...
<div class="col-md-6 nopadding_right">
    <div class="form-group">
	    <label class="field_name">Имя Поставщика (VENDOR_NAME)</label>
        <input class="form-control" type="text" name="payment[settings][vendor_name]" value="{$payment.settings.vendor_name}">
    </div>
</div>
<div class="col-md-6 nopadding_left">
    <div class="form-group">
